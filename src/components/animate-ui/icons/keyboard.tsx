...
const KeyboardIcon = forwardRef<KeyboardIconHandle, KeyboardIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 24, strokeWidth = 2, isHovered, ...props }, ref) => {
    ...
    const isEffectiveHover = isHovered ?? internalHover;
    ...
    useImperativeHandle(ref, () => {
      ...
      return {
        startAnimation: () => setInternalHover(true),
        stopAnimation: () => setInternalHover(false),
      };
    });
...
export { KeyboardIcon, KeyboardIcon as Keyboard };