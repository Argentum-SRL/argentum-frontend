...
export const CATALOGO_SUSCRIPCIONES: ServicioCatalogo[] = [
  ...
  { id: 'microsoft365',nombre: 'Microsoft 365',logoPath: getLogo('microsoft365.png'),categoria: 'Recreativo', frecuenciaDefault: 'anual',   color: '#0078D4', colorTexto: 'white' },
  { id: 'adobe',       nombre: 'Adobe CC',     logoPath: getLogo('adobecreativecloude.png'), categoria: 'Recreativo', frecuenciaDefault: 'mensual', color: '#FF0000', colorTexto: 'white' },
  ...
  { id: 'canva',       nombre: 'Canva',        logoPath: getLogo('canva.png'),       categoria: 'Recreativo', frecuenciaDefault: 'mensual', color: '#00C4CC', colorTexto: 'white' },
  { id: 'notion',      nombre: 'Notion',       logoPath: getLogo('notion.png'),      categoria: 'Recreativo', frecuenciaDefault: 'mensual', color: '#000000', colorTexto: 'white' },
  { id: 'evernote',    nombre: 'Evernote',     logoPath: getLogo('evernote.png'),    categoria: 'Recreativo', frecuenciaDefault: 'mensual', color: '#00A82D', colorTexto: 'white' },
  ...
  { id: 'grammarly',   nombre: 'Grammarly',    logoPath: getLogo('grammerly.png'),   categoria: 'Recreativo', frecuenciaDefault: 'anual',   color: '#15C39A', colorTexto: 'white' },
  ...
  // Delivery
  { id: 'rappi',       nombre: 'Rappi Prime',  logoPath: getLogo('rappipro.png'),    categoria: 'Restaurantes y delivery', frecuenciaDefault: 'mensual', color: '#FF441F', colorTexto: 'white' },
  { id: 'pedidosya',   nombre: 'PedidosYa Pass',logoPath: getLogo('pedidoya.png'),   categoria: 'Restaurantes y delivery', frecuenciaDefault: 'mensual', color: '#FF0050', colorTexto: 'white' },
