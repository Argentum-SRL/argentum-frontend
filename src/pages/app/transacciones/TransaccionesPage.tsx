  ...
  return (
    <div className={styles.container}>
      ...
      <Modal 
        ...
        footer={
          <>
            <Button variant="secondary" onClick={() => setIsModalTxOpen(false)}>Cancelar</Button>
            <Button onClick={handleSaveTx}>Guardar transacción</Button>
          </>
        }
      >
      ...
      <Modal
        ...
        footer={
          <>
            <Button variant="secondary" onClick={() => setIsModalTrOpen(false)}>Cancelar</Button>
            <Button onClick={handleSaveTr}>Realizar transferencia</Button>
          </>
        }
      >
        <div className={styles.formRow}>
      ...
      {selectedTx && (
        <Modal
          ...
          footer={
            <>
              <Button variant="secondary" onClick={() => setIsModalConfirmIAOpen(false)}>Cancelar</Button>
              <Button onClick={handleConfirmIA}>Confirmar y guardar</Button>
            </>
          }
        >
